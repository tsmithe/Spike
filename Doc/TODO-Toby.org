...
*** DONE Electrodes: record activation
CLOSED: [2017-03-22 Wed 13:40]
:LOGBOOK:
- State "DONE"       from "TODO"       [2017-03-22 Wed 13:40]
:END:
...
:END:
*** DONE Correct transfer function for PageHD (with slope and threshold)
CLOSED: [2017-03-22 Wed 13:40]
:LOGBOOK:
- State "DONE"       from "PROGRESS"   [2017-03-22 Wed 13:40]
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 18:50]
:END:
*** PROGRESS Proper weight initialization
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-24 Tue 10:55]
:END:
**** PROGRESS For prewired model
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 15:35]
:END:
***** PROGRESS Recurrent inhibition: HD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 15:35]
:END:
***** PROGRESS Recurrent inhibition: AHVxHD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 15:55]
:END:
***** PROGRESS Identity: VIS -> HD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 16:10]
:END:
***** PROGRESS Identity ('segregated'): AHV -> AHVxHD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 16:20]
:END:
***** PROGRESS Offset/non-offset: HD -> AHVxHD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 16:55]
:END:
***** PROGRESS Offset/non-offset: AHVxHD -> HD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 17:20]
:END:
****** TODO Check this!
**** TODO For self-organising model
***** TODO Details go here!
*** PROGRESS Axonal conduction delays
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-30 Mon 13:05]
:END:
**** DONE RateSynapses::delay sets storage size for corresponding presynaptic RateNeurons
CLOSED: [2017-01-30 Mon 15:35]
:LOGBOOK:
- State "DONE"       from "TODO"       [2017-01-30 Mon 15:35]
:END:
**** TODO Performance enhancements: references, not copies, where possible
*** PROGRESS Input 'networks'
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-30 Mon 16:35]
:END:
**** PROGRESS VIS: Pre-defined Gaussian bump + identity connections to HD
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 17:45]
:END:
**** DONE Compute VIS according to recent Page & Stringer
CLOSED: [2017-03-22 Wed 13:40]
:LOGBOOK:
- State "DONE"       from "TODO"       [2017-03-22 Wed 13:40]
:END:
**** PROGRESS AHV: ROT and NOROT
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 17:45]
:END:
*** PROGRESS Implement plasticity rules, including competition
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-30 Mon 13:05]
:END:
**** TODO At first, no plasticity
**** PROGRESS Weight normalization
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-30 Mon 13:05]
:END:
*** PROGRESS Support sparse connectivity
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-30 Mon 15:35]
:END:
**** PROGRESS Sparse Hebb update: use element_prod to zero unconnected inputs
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-30 Mon 15:35]
:END:
*** PROGRESS Simulation protocol
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-22 Wed 13:40]
:END:
**** PROGRESS Prewired model
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 18:50]
:END:
***** PROGRESS VIS -> HD initialisation
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 18:50]
:END:
***** PROGRESS NOROT, ROT, NOROT
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-20 Mon 18:15]
:END:
**** TODO Self-organising model
***** TODO Details here ...
** Software engineering
*** PROGRESS Shared API with Spiking classes
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-03-24 Fri 17:45]
:END:
**** CANCELLED Don't need RateSynapses separate from RateNeurons if we have SynapseGroups: integrate the Synapses with the Neurons...
CLOSED: [2017-03-24 Fri 21:00]
:LOGBOOK:
- State "CANCELLED"  from "TODO"       [2017-03-24 Fri 21:00] \\
  See notes below
:END:
+ OR: have a vacuous RateSynapses class
+ Should just have the synapse matrix in the Neurons class, and SynapseGroup descriptors (and views onto the matrix)
+ What about multiple synapses?...
+ And what about other inputs?
+ So it seems that a RateSynapses base class is necessary
**** TODO RateSynapseGroup is a [view of a] block of the main weight matrix
+ When a group is added, copy its elements to the CPU sparse matrix
+ This invalidates the backend weight matrix, which must be automatically updated when required
**** TODO Use sparse matrix-matrix multiplication to select delayed rates?
**** TODO Convenience Neurons.connect_input function: directly allow SynapseGroup input -- auto-create Synapses?
*** TODO Documentation
*** TODO Split classes into separate compilation units
*** TODO Clean up code
*** TODO Fix RateNeurons inheritance hierarchy
*** TODO Fix horrid inefficiency of RateNeurons::_rate methods (copying etc)
*** TODO Signal handlers
*** TODO RNG initialization
*** TODO Buffering shouldn't be in apply / update / integrate functions
*** PROGRESS Data members shouldn't be public
:LOGBOOK:
- State "PROGRESS"   from "TODO"       [2017-01-24 Tue 10:55]
:END:
*** TODO Make sure threaded IO is really working ...
- perhaps only one IO thread?
*** TODO Network descriptor file parser?
