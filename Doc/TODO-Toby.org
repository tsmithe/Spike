...
*** TODO Electrodes: record activation
...
:END:
*** PROGRESS Correct transfer function for PageHD (with slope and threshold)
:LOGBOOK:
...
:END:
**** TODO Compute VIS according to recent Page & Stringer
