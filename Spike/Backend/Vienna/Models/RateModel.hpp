...
namespace Backend {
  namespace Vienna {
    ...
    public:
      ...
      Eigen::VectorXi delay() override;
      void delay(Eigen::VectorXi const& d) override;

    private:
      unsigned int _max_delay = 0;
      viennacl::vector<int> _delays;
    ...
    */
    ...
    private:
      ...
      virtual viennacl::vector<FloatT> _rate(viennacl::vector<int> const& n_back);
