...
#define OUTPUT_PATH "PLACE_square"
...
int main(int argc, char *argv[]) {
  ...
  for (unsigned i = 0; i < 6; ++i) {
    agent.add_velocity(3.5, (1.0/3.0)*i*M_PI);
  }
...
"xxxxxxxxxxxxxxxxx\n"
  ...
  */
  ...
  FloatT test_duration = 945; // turns off plasticity during testing for this duration
  ...
  */
  ...
  FloatT FVxHD_PLACExFVxHD_scaling = 64.0 / (FVxHD_PLACExFVxHD_sparsity*N_FVxHD); // 800

  // PLACE -> PLACExFVxHD connectivity:
  FloatT PLACE_PLACExFVxHD_sparsity = 0.05;
  FloatT PLACE_PLACExFVxHD_scaling = 684.0 / (N_PLACE*PLACE_PLACExFVxHD_sparsity); // 950

  // PLACExFVxHD -> PLACExFVxHD connectivity:
  FloatT PLACExFVxHD_inhibition = -231.0 / N_PLACExFVxHD; // -500
  ...
  FloatT PLACExFVxHD_PLACE_scaling = 8977.0 / N_PLACExFVxHD; // 6400 // ???14000

  // PLACE -> PLACE connectivity:
  FloatT PLACE_inhibition = -100.0 / N_PLACE; // -2000
