...
:END:
** TODO Make SPIKE_MAKE_INIT_BACKEND more general (fewer ifdefs for sustainability...)
...
** TODO To improve compile times, stop having each backend depend on the headers of all the others
